...
BTreeNode *BTreeNode::searchData(int id)
{
    int i = 0;
...
void BTree::insertData(int id, string name, int age)
{
    if (root == NULL)
    {
...
void BTreeNode::insertNonFull(int id, string name, int age)
{
    int i = n - 1;
    if (isLeaf == true)
    {
...
void BTreeNode::deleteData(int id)
{
...
void BTreeNode::leafRemove(int index)
{
...
void BTreeNode::nonLeafRemove(int index)
{
...
TableData *BTreeNode::getPredecessor(int index)
{
...
TableData *BTreeNode::getSuccessor(int index)
{
